# UAQE Autonomous Optimization Report — Job UAQE-20260909-131603-5C90DE51
...
| **Host Latency (mean)** | 2.97 ms | **62.65 ms** | **+-2006.73% speedup** |
| **Throughput** | 336.27 img/s | **15.96 img/s** | +-95.3% |
...
- **cand_001 (MobileNetV3 Static INT8 PTQ):** Acc=95.94% (+1.02 pp, ACCEPTABLE), Size=1.77 MB, Latency=62.65 ms, Score=0.6690 [SELECTED]
- **cand_002 (MobileNetV3 INT8 PTQ + Magnitude Pruning):** Acc=95.94% (+1.02 pp, ACCEPTABLE), Size=1.77 MB, Latency=63.06 ms, Score=0.6690 [REJECTED]
- **cand_003 (MobileNetV3 INT8 + Adaptive Sparse RLE Packaging):** Acc=95.94% (+1.02 pp, ACCEPTABLE), Size=1.77 MB, Latency=125.52 ms, Score=0.6690 [REJECTED]
- **cand_004 (MobileNetV3 XNNPACK-Compatible INT8):** Acc=95.43% (+1.52 pp, ACCEPTABLE), Size=1.77 MB, Latency=4.50 ms, Score=0.6664 [REJECTED]